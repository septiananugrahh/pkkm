<template>
    <PublicTemplate>
            ...
            <v-card class="password-dialog">
                <v-card-title class="pa-6 text-center">
                    <div class="mb-4">
                        ...
                        >
                            <v-icon size="40" color="indigo">mdi-lock</v-icon>
                        </div>
                    ...
                    <v-form @submit.prevent="verifyPassword">
                        ...
                        >
                            <template v-slot:prepend-inner>
                                <v-icon color="indigo">mdi-key</v-icon>
                            </template>
                        </v-text-field>
        ...
        <div v-if="isAuthenticated">
            ...
            <div
                class="relative overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-cyan-50 pt-20"
            >
                <!-- Floating Elements -->
                <div
                    class="absolute top-20 left-10 w-16 h-16 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full opacity-20 animate-pulse"
                ></div>
                <div
                    class="absolute top-40 right-20 w-12 h-12 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full opacity-20 animate-bounce"
                ></div>
                ...
                <div class="relative py-16 sm:py-24">
                    <div class="mx-auto max-w-7xl px-6 lg:px-8">
                        <div class="mx-auto max-w-3xl text-center mb-16">
                            <!-- Badge -->
                            <div
                                class="mb-6 inline-flex items-center rounded-full bg-indigo-100 px-4 py-2 text-sm font-medium text-indigo-800 ring-1 ring-indigo-200 animate-fade-in"
                            >
                                <v-icon class="mr-2" size="small" color="indigo"
                            ...
                            <!-- Main Heading -->
                            <h1
                                class="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl animate-slide-up"
                            >
                                <span class="block text-gray-900 mb-2"
                                    >Struktur</span
                                >
                                <span
                                    class="block bg-gradient-to-r from-indigo-600 via-purple-600 to-cyan-600 bg-clip-text text-transparent"
                                >
                                    Penilaian Kinerja
                                </span>
                            ...
                            <!-- Subtitle -->
                            <p
                                class="mt-6 text-lg leading-8 text-gray-600 max-w-2xl mx-auto animate-fade-in-delay"
                            >
                                Akses data penilaian kinerja kepala madrasah
                                secara transparan dan terstruktur berdasarkan
                                tahun penilaian.
                            </p>
                        </div>
                    </div>
            ...
            <div class="py-16 bg-white">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div class="mb-12 animate-fade-in-delay-2">
                        <div
                            class="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-200/50 hover:shadow-xl transition-all duration-300"
                        >
                            <div class="flex items-center mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">
                                        Pilih tahun untuk melihat data penilaian
                                        yang sesuai
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="animate-fade-in-delay-3">
                        ...
                        <div class="mb-8 text-center">
                            ...
                            <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                                Berikut adalah struktur hierarkis data penilaian
                                kinerja kepala madrasah yang dapat Anda akses.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            >
                                <div
                                    class="bg-gradient-to-r from-indigo-50 to-indigo-100 rounded-2xl p-6 border border-indigo-200"
                                >
                                    <div class="flex items-center">
                                        <div
                                            class="w-12 h-12 bg-indigo-600 rounded-xl flex items-center justify-center mr-4"
                                        >
                                            <v-icon color="white"
                                ...
                                <div
                                    class="bg-gradient-to-r from-purple-50 to-purple-100 rounded-2xl p-6 border border-purple-200"
                                >
                                    <div class="flex items-center">
                                        <div
                                ...
                                <div
                                    class="bg-gradient-to-r from-cyan-50 to-cyan-100 rounded-2xl p-6 border border-cyan-200"
                                >
                                    <div class="flex items-center">
                                        <div
                                            class="w-12 h-12 bg-cyan-600 rounded-xl flex items-center justify-center mr-4"
                                        >
                                            <v-icon color="white"
                                                >mdi-eye</v-icon
                                            >
                        ...
                        <div v-else class="text-center py-16">
                            ...
                            <p class="text-gray-600 mb-6 max-w-md mx-auto">
                                Belum ada data penilaian untuk tahun yang
                                dipilih. Silakan pilih tahun lain atau hubungi
                                administrator.
                            </p>
                            <button
                                @click="reload"
            ...
            <div class="py-16 bg-gradient-to-r from-indigo-600 to-purple-600">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="text-center">
                        ...
                        <p
                            class="text-xl text-indigo-200 mb-8 max-w-2xl mx-auto"
                        >
                            Login sebagai administrator untuk mengakses fitur
                            manajemen dan laporan lengkap
                        </p>
                        ...
                        >
                            <v-icon class="mr-2" color="indigo"
                                >mdi-login</v-icon
                            >
                            Login Administrator
                        </Link>
...
onMounted(() => {
    const auth = sessionStorage.getItem("public_access_authenticated");
    if (auth === "true") {
...
const verifyPassword = async () => {
    ...
    try {
        ...
        if (response.data.status === "success") {
            ...
            //sessionStorage.setItem("public_access_authenticated", "true");
            password.value = "";
        }
    } catch (error) {
        errorMessage.value =
...
// Logout function
const logout = () => {
    sessionStorage.removeItem("public_access_authenticated");
